...
EXPERIMENT_NAME=data_preprocessing_datos3
...
###################################
# 3. (DATOS 1 + DATOS 2) + DATOS 3
###################################
INPUT_DATA_DIR=datos1_datos2_datos3
...
cp -r output/data_prep_datos1_datos2/$WINDOW_SIZE/mseed_event_windows output/$DATA_PREP_DIR
cp -r output/data_prep_datos1_datos2/$WINDOW_SIZE/mseed_noise output/$DATA_PREP_DIR
cp -r output/data_prep_datos3/$WINDOW_SIZE/mseed_event_windows output/$DATA_PREP_DIR  
cp -r output/data_prep_datos3/$WINDOW_SIZE/mseed_noise output/$DATA_PREP_DIR
