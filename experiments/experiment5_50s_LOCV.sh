...
--config_file_path experiments/config_50s.ini \
--tfrecords_dir output/data_prep_experiment5_50s_LOCV/tfrecords1 \
--checkpoint_dir output/train_experiment5_50s_LOCV/checkpoint1
...
--config_file_path experiments/config_50s.ini \
--tfrecords_dir output/data_prep_experiment5_50s_LOCV/tfrecords2 \
--checkpoint_dir output/train_experiment5_50s_LOCV/checkpoint2
...
--config_file_path experiments/config_50s.ini \
--tfrecords_dir output/data_prep_experiment5_50s_LOCV/tfrecords3 \
--checkpoint_dir output/train_experiment5_50s_LOCV/checkpoint3
...
--config_file_path experiments/config_50s.ini \
--tfrecords_dir output/data_prep_experiment5_50s_LOCV/tfrecords4 \
--checkpoint_dir output/train_experiment5_50s_LOCV/checkpoint4
