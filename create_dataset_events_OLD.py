...
def main(_):
    ...
    for stream_file in stream_files:
        ...
        for event_n in range(filtered_catalog.shape[0]):
            print("Found event in the catalog: "+str(event_n))
            ...
            if (len(st_event) == 3) and (n_pts == n_samples):
                print("Writing "+str(n_samples)+"samples for event "+str(event_n))
                # Write tfrecords
                ...
                if FLAGS.plot:
                    ...
                    st_event.plot(outfile=os.path.join(viz_dir,
                                                    "event_{}.png".format(event_n)))
                    #st_event.plot(outfile="tmp/"+output_name+"_"+str(event_n)+".png")
                    st_event.plot(outfile="tmp/"+output_name+"_"+str(event_n)+".png")
